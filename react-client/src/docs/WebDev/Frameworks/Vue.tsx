...
export default function VueDocs() {
    ...
    return (
        <>
            ...
            <div className="mt-36"/>
            <ArticleFeedback articleId="/alldocs/webdev/vue"/>
            ...
            <div className="gap-4 w-full bg-white text-gray-700 border border-gray-300 flex items-center justify-between">
                ...
                >
                    <div className="flex items-center gap-4">
                        <Icon icon="mdi:angular" width="40" height="40" className="text-[#DD0031]" />
                        <div className="flex flex-col items-start">
                            <h3 className="font-semibold text-lg text-left">Next Section</h3>
                            <p className="text-[#6b7280] text-left">Frameworks - Angular</p>
                        </div>
                    </div>
